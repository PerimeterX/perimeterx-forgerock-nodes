...
import com.perimeterx.pxNodes.PX.Crypto.PBKDF2Engine;
import com.perimeterx.pxNodes.PX.Crypto.PBKDF2Parameters;
import com.perimeterx.pxNodes.PX.Exceptions.PXCookieDecryptionException;
import com.perimeterx.pxNodes.PX.Utils.HMACUtils;
...
public abstract class AbstractPXCookie implements PXCookie {
    ...
    protected pxVerificationNode.Config pxConfiguration;
    protected String pxCookie;
    protected JsonNode decodedCookie;
    protected String cookieKey;
    protected String cookieOrig;

    public AbstractPXCookie(pxVerificationNode.Config pxConfiguration, CookieData cookieData) {
