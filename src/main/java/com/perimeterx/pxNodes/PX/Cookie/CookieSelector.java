...
public class CookieSelector {
    ...
    public static AbstractPXCookie selectFromTokens(PXContext ctx, pxVerificationNode.Config pxConfiguration) {
    ...
    public static AbstractPXCookie getOriginalToken(PXContext ctx, pxVerificationNode.Config pxConfiguration)
    ...
    private static AbstractPXCookie buildPxCookie(PXContext ctx, pxVerificationNode.Config pxConfiguration, String cookie,
