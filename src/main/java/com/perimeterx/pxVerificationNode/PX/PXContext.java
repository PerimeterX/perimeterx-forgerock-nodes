package com.perimeterx.pxVerificationNode.PX;
...
import com.perimeterx.pxVerificationNode.PX.ActivitiesData.BlockAction;
import com.perimeterx.pxVerificationNode.PX.ActivitiesData.BlockReason;
import com.perimeterx.pxVerificationNode.PX.ActivitiesData.PassReason;
import com.perimeterx.pxVerificationNode.PX.ActivitiesData.VidSource;
...
import com.perimeterx.pxVerificationNode.PX.RiskAPI.S2SErrorReasonInfo;
import com.perimeterx.pxVerificationNode.PX.Utils.PXUtils;
    ...
    private void parseCookies(final ExternalRequestContext req) {
        if (req.headers.containsKey(PXConstants.MOBILE_SDK_AUTHORIZATION_HEADER)) {
            ...
            if (this.cookies.isEmpty() &&
                    this.pxConfiguration.pxHardcodedCookie() != null) {
                this.cookies.add(new PXRawCookie("_px3",
                        this.pxConfiguration.pxHardcodedCookie()));
            }
        }
    }
