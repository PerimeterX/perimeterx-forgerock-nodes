 ...
 * @since AM 5.5.0
 */
public class pxVerificationNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(pxVerificationNodePlugin.currentVersion,
                Collections.singletonList(pxVerificationNode.class));
    }
    ...
    public String getPluginVersion() {
        return pxVerificationNodePlugin.currentVersion;
    }
}
